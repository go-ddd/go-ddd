...
func init() {
	...
	eventDescVersion := eventMixinFields2[0].Descriptor()
	...
	eventDescCreator := eventMixinFields3[0].Descriptor()
	...
	eventDescOrgID := eventFields[2].Descriptor()
	...
	eventDescInstanceID := eventFields[3].Descriptor()
	...
	eventDescService := eventFields[9].Descriptor()
	...
	eventDescCreateTime := eventFields[10].Descriptor()
