...
func (ec *EventCreate) SetAge(i int) *EventCreate {
...
func (ec *EventCreate) SetNickname(s string) *EventCreate {
...
func (ec *EventCreate) check() error {
	if _, ok := ec.mutation.Age(); !ok {
		return &ValidationError{Name: "age", err: errors.New(`do: missing required field "Event.age"`)}
	}
	if _, ok := ec.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`do: missing required field "Event.name"`)}
	}
	if _, ok := ec.mutation.Nickname(); !ok {
		return &ValidationError{Name: "nickname", err: errors.New(`do: missing required field "Event.nickname"`)}
	}
	return nil
}
